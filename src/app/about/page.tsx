...
export default function AboutPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-20">
      <h1 className="mb-8 text-4xl font-bold tracking-wide">About Backtext</h1>
      ...
      <p className="mb-4 text-lg leading-relaxed">
        ...
        starts with <strong>3 free credits</strong> so you can try it out. When
        you’re ready for unlimited creation, simply upgrade to our affordable
      ...
      <p className="mb-10 text-lg leading-relaxed">
        Whether you’re preparing marketing visuals, creating content for social
        media, or experimenting with design ideas — Backtext helps you move from
        concept to polished output in seconds.
      </p>
